...
class Image
{
     ...
     *
     * @param int|string $width  The new width in number (pixels) or percentage
     * @param int|string $height The new height in number (pixels) or percentage
     * @param int|string $x      The "x" position to crop. It can be number (pixels), percentage, [left, center, right] or one of the Image::CROP_* constants
     * @param int|string $y      The "y" position to crop. It can be number (pixels), percentage or [top, middle, bottom]
     *
     * @return self
     */
